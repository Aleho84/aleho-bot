import { REST, Routes, Client, GatewayIntentBits, WebhookClient, Events } from 'discord.js';
...
setInterval(async () => {
    taskHandler(hook);
    if (constant.DEBUG === true) { console.log('***DEBUG***: Discord taskHandler triggered'); }
